...
public class GameBoard3 implements MouseListener
{
	...
	public GameBoard3(String p1, String p2, String p3) 
	{
		player1 = p1;
		player2 = p2;
		player3 = p3;
	...
	void iniGUI()
	{
		...
		table2.setPreferredScrollableViewportSize(new Dimension(850, 800));
		table2.setComponentOrientation(ComponentOrientation.LEFT_TO_RIGHT);
		table2.setFont(new Font("OCR A Extended", Font.PLAIN, 15));
		table2.setModel(new DefaultTableModel(
			new Object[][] {
				...
				{"UPPER SCORE", null, null, null},
				{"UPPER BONUS [35]", null, null, null},
				{"PAIR", null, null, null},
				{"THREE OF A KIND", null, null, null},
				{"FOUR OF A KIND", null, null, null},
				{"FULL HOUSE [25]", null, null, null},
				{"SMALL STRAIGHT [30]", null, null, null},
				{"LARGE STRAIGHT[40]", null, null, null},
				{"YATZY [50]", null, null, null},
				{"CHANCE", null, null, null},
				{"LOWER SCORE", null, null, null},
				{"TOTAL", null, null, null},
			},
			new String[] {
				"    Combinations", player1, player2, player3
			}
		) {
			Class[] columnTypes2 = new Class[] {
				String.class, String.class, String.class, String.class
			};
			public Class getColumnClass2(int columnIndex2) {
				return columnTypes2[columnIndex2];
			}
		});
		table2.getColumnModel().getColumn(0).setPreferredWidth(229);
		table2.getColumnModel().getColumn(1).setPreferredWidth(209);
		table2.getColumnModel().getColumn(2).setPreferredWidth(209);
		table2.getColumnModel().getColumn(3).setPreferredWidth(209);
		table2.setBackground(Color.GRAY);
		
		
		scrollPane2 = new JScrollPane();
		scrollPane2.setForeground(Color.GRAY);
		scrollPane2.setFont(new Font("OCR A Extended", Font.PLAIN, 15));
		scrollPane2.setBounds(295, 32, 731, 457);
		scrollPane2.setViewportView(table2);
		panelGame.add(scrollPane2);
